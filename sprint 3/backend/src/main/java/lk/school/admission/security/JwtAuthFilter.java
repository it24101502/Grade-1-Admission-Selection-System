// ================================================================
//  FILE: src/main/java/lk/school/admission/security/JwtAuthFilter.java
//
//  This filter runs on EVERY incoming API request.
//  It reads the JWT token from the request header, validates it,
//  and if valid, sets the user as "logged in" for that request.
// ================================================================
